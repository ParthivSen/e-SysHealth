<?php
exec("C:\Users\HP\Desktop\Python\Python311\python.exe python/viewall-building.py ", $output, $return);
                            ...
                            <div class="card alert">
                                <div class="card-body">
                                    <div class="basic-elements">
                                        <form action="connector-building.php" method="post">
                                            <h2>Building Info</h2>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="name" required placeholder="Building Name">
                                                    </div>
                                                    <div class="form-group">
                            ...
                            <div class="col-sm-12 col-sm-offset-0 col-md-12 col-md-offset-0 col-lg-12 col-lg-offset-0">
                                <div class="card alert">
                                    <div class="card-body">
                                        <div class="basic-elements">
                                            <div class="col-lg-6">
                                                <p>Building ID: <?php echo $json_a[$i]["_id"]; ?></p>
                                                <p>Building Name: <?php echo $json_a[$i]["name"]; ?></p>
                                                <p>Multistorey: <?php echo $json_a[$i]["multi"]; ?></p>
                                            </div>
                                            <div class="col-lg-6">
                                                <form method="post">
                                                    <input type="text" name="updateid" id="upd" value="<?php echo $json_a[$i]["_id"]; ?>" hidden>
                                                    <input type="submit" class="btn btn-primary m-b-10 m-l-5" style="background: green;" formaction="update-building.php" value="Update">
                                                    <input type="submit" class="btn btn-primary m-b-10 m-l-5" style="background: red;" formaction="delete-building.php" value="Delete">
                                                </form>
                                            </div>
                                        </div>
                                    </div>
