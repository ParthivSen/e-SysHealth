                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label>ID</label>
                                                        <input type="text" class="form-control" name="query" id="query" placeholder="Enter ID">
                                                    </div>
                                                </div>
                                            </div>
                                            <input type="submit" class="btn btn-primary m-b-10 m-l-5" value="Download" formaction="download.php">
                                            <input type="submit" class="btn btn-primary m-b-10 m-l-5" value="View" formaction="view.php">
                                        </form>
                                    </div>
                                </div>
                            </div>
