<?php
    ...
    exec("C:\Users\HP\Desktop\Python\Python311\python.exe python/update-division.py $_id", $output, $return);
                            ...
                            <div class="card alert">
                                <div class="card-body">
                                    <div class="basic-elements">
                                        <form action="update-divisionverify.php" method="post">
                                            <h2>Update Division/Group</h2>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="grp_name" value="<?php echo $json_a[0]["grp_name"];?>" placeholder="Group Name">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Group Abbreviation</label>
                                                        <input type="text" class="form-control" name="grp_abbr" value="<?php echo $json_a[0]["grp_abbr"];?>" placeholder="Group Abbreviation">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Group Order</label>
                                                        <input type="text" class="form-control" name="grp_order" value="<?php echo $json_a[0]["grp_code"];?>" placeholder="Group Order">
                                                    </div>
                                                    <h4>Division</h4>
                                                    <div class="form-group">
                                                        <label>Division Name</label>
                                                        <input type="text" class="form-control" name="div_name" value="<?php echo $json_a[0]["div"]["div_name"];?>" placeholder="Division Matrix">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Division Abbreviation</label>
                                                        <input type="text" class="form-control" name="div_abbr" value="<?php echo $json_a[0]["div"]["div_abbr"];?>" placeholder="Division Level">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Others</label>
                                                        <input type="text" class="form-control" name="others" value="<?php echo $json_a[0]["other"];?>" placeholder="Others">
                                                    </div>
                                                </div>
                                            </div>
